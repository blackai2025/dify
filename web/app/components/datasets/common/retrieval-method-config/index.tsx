    ...
    <div className='flex flex-col gap-y-2'>
      ...
      <div className='mt-4 rounded-xl border border-divider-subtle p-4'>
        <div className='flex items-start justify-between'>
          <div className='flex-1'>
            <div className='flex items-center gap-2'>
              ...
              >
                <RiInformationLine className='h-3.5 w-3.5 text-text-tertiary cursor-help' />
              </Tooltip>
            </div>
        ...
        {value.filter_enabled && (
          <div className='mt-3 rounded-lg bg-background-section-burn p-3 space-y-2'>
              ...
              ? (
                <>
                  ...
                  <button
                    ...
                    className='inline-flex items-center gap-1 text-xs text-text-accent hover:underline cursor-pointer'
                  >
                ...
                <div className='flex items-start gap-2'>
                  ...
                  <div className='flex-1'>
                    ...
                    <button
                      type='button'
                      onClick={() => setShowAccountSettingModal({ payload: 'filter-rules' })}
                      className='mt-1 inline-flex items-center gap-1 text-xs text-text-accent hover:underline cursor-pointer'
                    >
                      <RiFilter2Line className='h-3.5 w-3.5' />
