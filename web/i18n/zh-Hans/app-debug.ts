const translation = {
  ...
  datasetConfig: {
    ...
    smartFilter: {
      title: '智能过滤',
      description: '基于结构化实体和属性匹配，智能过滤掉不相关的召回文档。',
      tooltipTitle: '智能过滤',
      suitableFor: '适用场景：',
      useCase1: '具有结构化数据的领域知识库（如：商品、订单）',
      useCase2: '需要精确实体/属性过滤的场景',
      howItWorks: '工作原理：',
      mechanism: '从查询中提取实体/属性 → 与过滤规则匹配 → 过滤召回文档',
      rulesConfigured: '已配置过滤规则：{{entities}} 个实体，{{attributes}} 个属性',
      viewRules: '查看过滤规则',
      noRulesWarning: '尚未配置过滤规则',
      addRulesNow: '立即添加规则',
    },
  },
  ...
  agent: {
    ...
    setting: {
      ...
      keepUserQueryAsKbQuery: {
        name: '将用户输入作为知识库查询',
        description: '将用户输入作为知识库查询',
      },
      forceRag: {
        name: '强制执行 RAG',
        description: '强制执行 RAG',
      },
